...
public class BoardRestController {
	...
	@RequestMapping(value="/BoardListAjax/{pagePerCnt}/{page}", produces = {MediaType.APPLICATION_XML_VALUE, MediaType.APPLICATION_JSON_UTF8_VALUE})
	public HashMap<String, Object> listSub(@PathVariable int page, @PathVariable int pagePerCnt, Criteria cri){
		HashMap<String, Object> json = new HashMap<String,Object>();
		cri.setAmount(pagePerCnt); // 페이지당 보여줄 수
